            ...
            <nav class="-mx-3 space-y-6">
                ...
                <div class="space-y-3">
                    ...
                    >
                        ...
                        <span class="mx-2 text-sm font-medium">Empleados</span>
                    </Link>
                </div>
                ...
                <div class="space-y-3">
                    ...
                    >
                        ...
                        <span class="mx-2 text-sm font-medium">Paises</span>
                    </Link>
                    ...
                    >
                        ...
                        <span class="mx-2 text-sm font-medium">Estados</span>
                    </Link>
                    <Link
                        class="flex items-center px-3 py-2 text-gray-600 transition-colors duration-300 transform rounded-lg dark:text-gray-200 hover:bg-gray-100 dark:hover:bg-gray-800 dark:hover:text-gray-200 hover:text-gray-700"
                        href="/admin/cities"
                    >
                        ...
                        <span class="mx-2 text-sm font-medium">Ciudades</span>
                    </Link>
                    <Link
                        class="flex items-center px-3 py-2 text-gray-600 transition-colors duration-300 transform rounded-lg dark:text-gray-200 hover:bg-gray-100 dark:hover:bg-gray-800 dark:hover:text-gray-200 hover:text-gray-700"
