            ...
            <div class="flex justify-between h-16">
                ...
                <div class="hidden sm:flex sm:items-center sm:ml-6">
                    <x-dropdown placement="bottom-end">
                        <x-slot name="trigger">
                            <button class="flex items-center text-sm font-medium text-gray-800 bg-white hover:text-gray-700 focus:outline-none transition duration-150 ease-in-out dark:bg-gray-900 dark:text-gray-400 dark:hover:text-gray-200">
